...
namespace Mic.Repository.Dapper
{
         ...
         where TConnection : IDbConnection, new()
    {
        ...
        /// <returns>Multiple result sets</returns>
        public Tuple<IEnumerable<TFirst> , IEnumerable<TSecond> > QueryMultiple<TFirst, TSecond>(
        ...
        /// <typeparam name="TSecond">The type of the second sql recordset.</typeparam>
        /// <returns>Multiple result sets</returns>
        public async Task<Tuple<IEnumerable<TFirst>, IEnumerable<TSecond>>>
        ...
        /// <returns>Multiple result sets</returns>
        public Tuple<IEnumerable<TFirst> , IEnumerable<TSecond> , IEnumerable<TThird>>
        ...
        /// <returns>Multiple result sets</returns>
        public async
            Task<Tuple<IEnumerable<TFirst>, IEnumerable<TSecond>, IEnumerable<TThird> >>
